	...
	<div class="comments" id="comments">
		...
		<div class="comments-header section-inner small max-percentage">
			...
			if ( ! have_comments() ) {
				...
				printf( _x( 'Un commentaire dans &ldquo;%s&rdquo;', 'comments title', 'twentytwenty' ), get_the_title() );
			} else {
				printf(
					/* translators: 1: Number of comments, 2: Post title. */
					_nx(
						'%1$s commentaire dans &ldquo;%2$s&rdquo;',
						'%1$s commentaires dans &ldquo;%2$s&rdquo;',
						$comments_number,
						'comments title',
						'twentytwenty'
					),
